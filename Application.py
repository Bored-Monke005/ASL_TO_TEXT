...
class Application:
    ...
    def __init__(self):
        self.hs = pynuspell.load_from_path("en_US")
        ...
        # ct is a dict that contains counts of alphabets
        self.ct = {}
        self.ct['blank'] = 0
        self.blank_flag = 0

        # setting alphabets' counts to zero
        ...
        # str               => typed sentence
        # current_symbol    => identified_alphabet
        self.str = ""
        self.word = " "
    ...
    def predict(self, test_image):
        ...
        if(self.ct[self.current_symbol] > 6):
            ...
            for i in ascii_uppercase:
                ...
                # tmp is used to measure precision by checking
                # how much greater is the current word frequency 
